    ...
    >
      ...
      >
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-glow-red">
            INFORMATION SNACKS
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10">
          <div className="space-y-8">
            ...
            <div className="cyber-box p-6 bg-black/50 backdrop-blur-sm border-red-500/20">
              ...
              <p className="text-xl text-muted-foreground">
                Think of economic memes that make people believe they've grasped
                macroeconomic forces—when in truth, they've simply been
                manipulated into feeling in control, not understanding.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="cyber-box p-6 bg-black/50 backdrop-blur-sm border-red-500/20">
              ...
              <p className="text-xl text-muted-foreground">
                Memes generate ideas that eventually create realities, which in
                turn feed the memes themselves, allowing them to keep
                reproducing.
              </p>
            ...
            <div className="cyber-box p-6 bg-black/50 backdrop-blur-sm border-red-500/20">
              ...
              <p className="text-xl text-muted-foreground">
                It's the recursive media loop described in Videodrome, now lived
                daily—the Memedrome. This is the memification of culture beyond
                "funny posts." It's not just humor—it's symbolic compression
                weaponized.
              </p>
              <div className="mt-4 p-3 bg-black/30 rounded-md border border-red-500/20">
                <p className="text-sm italic text-red-400">
                  "The retina becomes the screen. The screen becomes the
                  retina." — Brian O'Blivion, Videodrome
                </p>
              </div>
            </div>
          </div>
